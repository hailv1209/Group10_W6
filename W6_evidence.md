...
| **Tổng Chi Phí (W6)** | Tổng chi phí dự kiến của hệ thống là khoảng **USD ~$25.37**, vẫn nằm an toàn dưới giới hạn **$150 Cost Cap** theo hard rule của mentor. So với tuần trước khi nhóm từng phát sinh chi phí khoảng **$1600**, chi phí vận hành hiện tại đã được giảm khoảng **63 lần** (~98.4%), cho thấy các hoạt động cost optimization và infrastructure simplification trong W6 đã mang lại hiệu quả đáng kể. <img width="780" height="504" alt="image" src="https://github.com/user-attachments/assets/08481d80-e85c-4cae-b4c6-8eff0f7a584e" /> |
...
| **Người Nhận Cảnh Báo** | Gửi email tới cho Finance team |
